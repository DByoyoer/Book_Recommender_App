...
// CODE FROM: https://stackoverflow.com/questions/64913067/reorder-lazycolumn-items-with-drag-drop/73592914#73592914
...
fun <T : Any> DragDropColumn(
    ...
    LazyColumn(
        modifier = Modifier.pointerInput(dragDropState) {
            ...
            }, onDragStart = { offset -> dragDropState.onDragStart(offset) }, onDragEnd = {
        ...
        itemsIndexed(items = items) { index, item ->
            DraggableItem(
                dragDropState = dragDropState, index = index, modifier = Modifier
            ) { isDragging ->
